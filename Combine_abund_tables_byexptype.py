...
# Separate the studies by their experiment_type
...
for experiment_type, study_ids in experiment_type_dict.items():
    ...
    if abund_dfs_genus:
        ...
        # Save the DataFrame to a csv file
        studies_per_sample_genus_df.to_csv(f'Abundance_tables/Merged_tables/{experiment_type}/{experiment_type}_studies_per_sample.csv', index=False)
